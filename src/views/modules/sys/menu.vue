  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__menu">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" row-key="id" border style="width: 100%;">
        ...
        <el-table-column prop="type" :label="$t('menu.systemType')" header-align="center" align="center">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.systemType === 0" size="small" style="border: 0px;background-color: #fff;">{{ $t('menu.systemType0') }}</el-tag>
            <el-tag v-else size="small" type="info" style="border: 0px;background-color: #fff;color: #000;">{{ $t('menu.systemType1') }}</el-tag>
          </template>
        </el-table-column>
