...
export default {
    ...
    //querySpecificAnalysisList: querySpecificAnalysisList, // 获取专题分析列表
    // querySpecificAnalysisInfo: querySpecificAnalysisInfo, // 获取专题详情列表
    //deleteSpecificAnalysis: deleteSpecificAnalysis, // 删除专题
    //insertSpecificAnalysisInfo: insertSpecificAnalysisInfo, // 创建专题分析
    //updateSpecificAnalysis: updateSpecificAnalysis,// 更新专题信息
    ...
    //getSpecificAnalysis: getSpecificAnalysis, // 获取专题详情 （新）

    updateBusinessAnaylsis: updateBusinessAnaylsis, //业务分析页面修改
    saveBusinessAnaylsis: saveBusinessAnaylsis, //业务分析页面新增
    //insertConfigurations: insertConfigurations, // 创建高级配置
    //deleteConfiguration: deleteConfiguration, // 删除高级配置项
    //deleteSpecificAnalysis: deleteSpecificAnalysis, // 删除专题
