            ...
            <div class="config_border" v-show="showItem">
                ...
                ">
                    ...
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="分组字段：" label-width="120px" ref="groupEnglishField" prop="groupEnglishField">
                                <el-select v-model="form.groupEnglishField" placeholder="请选择分组字段" style="width: 100%" @change="$refs.groupDictionaries.clearValidate()">
                                    <el-option v-for="item in tableValueList" :label="item.label" :key="item.dictvalue" :value="item.value"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="23">
                            <el-form-item label="一级树内容：" label-width="120px" prop="topTreeContent" :rules="
                  treeContentFlagTop
                    ? [
                        {
                          required: true,
                ...
                ">确定</el-button>
                    ...
                    <el-dialog :title="'编辑列表显示字段'" :visible.sync="showTableList.show" :destroy-on-close="true" append-to-body width="650px">
                        <el-transfer :titles="['候选列表', '已选列表']" class="transfer_table_list" :props="{ key: 'value', label: 'label' }" v-model="tableValue" :data="tablelist"></el-transfer>
                        <br />
                        <br />
                        <div class="button_line">
...
export default {
    ...
    methods: {
        reset() {
            // console.log('---------------tableValue%o',this.tableValue)
            // console.log('---------------tablelist%o',this.tablelist)
