<template>
    <div>
        ...
        <TripleToneChild v-for="(item,index) in configs" v-show="item.show" :ref="item.id + '_item'" :key="index" :config-data="item" :formData="form" :refashData="closeEvent" @childSub='childSub' onDelete="deleteEvent"></TripleToneChild>
...
<script>
import TripleToneChild from "./TripleToneChild";
